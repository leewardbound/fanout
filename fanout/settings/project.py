...
GRAPHENE = {
    "SCHEMA": "fanout.settings.schema.application_schema",
    "SCHEMA_OUTPUT": "./schema.graphql",
    "MIDDLEWARE": ["graphql_jwt.middleware.JSONWebTokenMiddleware"],
}

DATABASE_HOST = os.environ.get("DATABASE_HOST", "psql")
DATABASE_NAME = os.environ.get("DATABASE_NAME", "fanout")
DATABASE_USER = os.environ.get("DATABASE_USER", "fanout")
DATABASE_PORT = os.environ.get("DATABASE_PORT", "5432")
DATABASE_PASSWORD = os.environ.get("DATABASE_PASSWORD", "fanout")
...
APP_HOSTNAME = os.environ.get("APP_HOSTNAME", "fanout.boundcorp.net")
...
BACKEND_FOLDER = SITE_ROOT + "/fanout"
...
if os.path.exists(credentials_file):
    ...
    MINIO_STORAGE_MEDIA_BUCKET_NAME = os.environ.get("MINIO_STORAGE_MEDIA_BUCKET_NAME", "fanout-assets")
